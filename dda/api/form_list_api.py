...
class FormListApi(object):
    ...
    def folder_database_api_data_forms_get(self, folder, database, **kwargs):  # noqa: E501
        """Reads a list of forms.   # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.folder_database_api_data_forms_get(folder, database, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.folder_database_api_data_forms_get_with_http_info(folder, database, **kwargs)  # noqa: E501
        else:
            (data) = self.folder_database_api_data_forms_get_with_http_info(folder, database, **kwargs)  # noqa: E501
            return data

    def folder_database_api_data_forms_get_with_http_info(self, folder, database, **kwargs):  # noqa: E501
        """Reads a list of forms.   # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.folder_database_api_data_forms_get_with_http_info(folder, database, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method folder_database_api_data_forms_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if self.api_client.client_side_validation and ('folder' not in params or
            ...
            raise ValueError("Missing the required parameter `folder` when calling `folder_database_api_data_forms_get`")  # noqa: E501
        # verify the required parameter 'database' is set
        if self.api_client.client_side_validation and ('database' not in params or
                                                       params['database'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `database` when calling `folder_database_api_data_forms_get`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/{folder}/{database}/api/data/forms', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,

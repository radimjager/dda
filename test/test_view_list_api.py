...
import dda
from dda.api.view_list_api import ViewListApi  # noqa: E501
from dda.rest import ApiException


class TestViewListApi(unittest.TestCase):
    """ViewListApi unit test stubs"""

    def setUp(self):
        self.api = dda.api.view_list_api.ViewListApi()  # noqa: E501

    def tearDown(self):
        pass

    def test_folder_database_api_data_collections_get(self):
        """Test case for folder_database_api_data_collections_get
